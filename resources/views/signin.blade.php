  ...
  <div class="container">
    <div class="forms-container">
      <div class="signin-signup">
        <form action="{{route('user.signin.post')}}" method="POST" class="sign-in-form" required="yes">
          @csrf
          <h2 class="title">User Register</h2>
          <div class="input-field">
            <i class="fas fa-user"></i>
            <input type="text" name="FirstName" autocomplete="username" placeholder="FirstName" required="yes">
          </div>
          <div class="input-field">
            <i class="fas fa-user"></i>
            <input type="text" name="LastName" autocomplete="username" placeholder="LastName" required="yes">
          </div>
          <div class="input-field">
          ...
          <a class="pass" href="authentication-login.html">User Login</a>
        ...
        <form action="" class="sign-up-form">
          ...
          <a class="pass" href="#">Forgot your password?</a>
          <a class="pass" href="authentication-login.html">Admin Login</a>
          <input type="submit" value="Sign in" class="btn solid">
        </form>
      </div>
    </div>
