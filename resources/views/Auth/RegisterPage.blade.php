              ...
              <div class="card-body">
                ...
                <form action="{{ route('register.post') }}" method="POST">
                  ...
                  <div class="mb-3">
                    ...
                    <input type="text" class="form-control" name="FirstName" id="exampleInputtext1" aria-describedby="textHelp">
                  </div>
                  <div class="mb-3">
                    <label for="exampleInputtext1"  class="form-label">LastName</label>
                    <input type="text" class="form-control" name="LastName" id="exampleInputtext2" aria-describedby="textHelp">
                  </div>
                  <div class="mb-3">
